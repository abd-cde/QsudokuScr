    ...
    : QWidget(parent)
{
    ...
    cB_background->addItem(QIcon(":/png/M.png"),QString(tr("紫色")));
    cB_background->addItem(QIcon(":/png/X.png"),QString(tr("橘色")));
    cB_background->addItem(QIcon(":/png/G.png"),QString(tr("黄色")));
    cB_background->addItem(QIcon(":/png/R.png"),QString(tr("蓝色")));
    cB_background->setCurrentIndex(0);
    this->setAutoFillBackground(true);
    changeBackground(QString(tr("紫色")));
