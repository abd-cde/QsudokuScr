...
**
** Created: Mon May 19 14:52:58 2014
...
static const char qt_meta_stringdata_aboutDlg[] = {
    "aboutDlg\0\0showExeplanatry()\0showRule()\0"
    "showCopyright()\0"
};
...
void *aboutDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_aboutDlg"))
        return static_cast< Ui_aboutDlg*>(const_cast< aboutDlg*>(this));
...
int aboutDlg::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: showExeplanatry(); break;
        case 1: showRule(); break;
        case 2: showCopyright(); break;
        default: ;
        }
        _id -= 3;
    }
